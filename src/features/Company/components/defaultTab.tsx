    ...
    return (
      <div className="px-2">
        <div className="flex gap-2 py-2 [&_svg]:size-5">
          <PiMapPin className="min-w-[18px]"/> <p className="line-clamp-2 break-all">{company.address}</p>
        </div>
        <div className="flex gap-2 py-2 [&_svg]:size-5">
          <PiUsers className="min-w-[18px]"/> {company.employeeCount > 0 ? `${company.employeeCount.toLocaleString()}명` : '-'}
        </div>
        <div className="flex gap-2 py-2 [&_svg]:size-5">
