import competition from '@/src/entities/member/assets/competition.png';
import growth from '@/src/entities/member/assets/growth.png';
import point from '@/src/entities/member/assets/point.png';
import recruit from '@/src/entities/member/assets/recruit.png';
